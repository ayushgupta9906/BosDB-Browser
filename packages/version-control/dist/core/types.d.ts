...
export type Change = SchemaChange | DataChange | ViewChange | IndexChange | ConstraintChange;
...
export type MergeStrategy = 'RECURSIVE' | 'OURS' | 'THEIRS' | 'OCTOPUS' | 'FAST_FORWARD';
...
export type ReflogAction = 'COMMIT' | 'CHECKOUT' | 'MERGE' | 'REBASE' | 'CHERRY_PICK' | 'RESET' | 'PULL' | 'CLONE';
...
export type HookType = 'PRE_COMMIT' | 'POST_COMMIT' | 'PRE_MERGE' | 'POST_MERGE' | 'PRE_PUSH' | 'POST_PUSH';
